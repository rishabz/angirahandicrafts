        ...
        <div class="bg-body-secondary py-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-site py-0 d-flex justify-content-center">
                    <li class="breadcrumb-item"><a class="text-decoration-none text-body" href="{{$dashboardUrl}}"><i
                                class="fas fa-home-lg me-4 text-body-emphasis"></i> Home</a>
                    </li>
                    <li class="breadcrumb-item active pl-0 d-flex align-items-center" aria-current="page">Page Not Found
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div id="main-content" class="col">
                    <div class="content-404-wrapper">
                        ...
                        <a href="{{$dashboardUrl}}" class="btn btn-dark btn-hover-border-primary btn-hover-bg-primary">Go to home
                            page</a>
                    </div>
                </div>
            </div>
